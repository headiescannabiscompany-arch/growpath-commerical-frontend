...
describe("AlertCenterRoute", () => {
  ...
  it("loads alerts, creates tasks, resolves, and snoozes", async () => {
    ...
    expect(
      screen.getByLabelText("Alert link /home/commercial/evidence-runs/trial-1")
    ).toBeTruthy();
    expect(
      screen.getByLabelText("Alert link /home/commercial/evidence-runs/trial-linked-1")
    ).toBeTruthy();
    expect(
      ...
      expect(mockApiRequest).toHaveBeenCalledWith(
        ...
        expect.objectContaining({
          ...
          body: expect.objectContaining({
            ...
            priority: "critical",
            allDay: true,
            calendarType: "commercial_alert_followup",
            sourceStage: "product_alert_followup",
            sourceType: "alert",
            sourceId: "alert-1",
      ...
      expect(mockApiRequest).toHaveBeenLastCalledWith(
        ...
        expect.objectContaining({
          ...
          body: expect.objectContaining({
            ...
            allDay: true,
            calendarType: "personal_alert_followup",
            sourceStage: "product_alert_followup",
            storefrontSlug: "living-soil-labs",
            linkedStorefrontSlug: "living-soil-labs"
          })
      ...
      expect(mockApiRequest).toHaveBeenLastCalledWith(
        ...
        expect.objectContaining({
          ...
          body: expect.objectContaining({
            ...
            allDay: true,
            calendarType: "personal_alert_followup",
            sourceStage: "product_batch_alert_followup",
            linkedProductBatchId: "batch-linked-1",
            priority: "normal",
            status: "open"
          })
      ...
      expect(mockApiRequest).toHaveBeenLastCalledWith(
        ...
        expect.objectContaining({
          ...
          body: expect.objectContaining({
            ...
            allDay: true,
            calendarType: "commercial_alert_followup",
            sourceStage: "feed_campaign_alert_followup",
            linkedFeedCampaignId: "campaign-linked-1",
            priority: "normal",
            status: "open"
          })
      ...
      expect(mockApiRequest).toHaveBeenLastCalledWith(
        ...
        expect.objectContaining({
          ...
          body: expect.objectContaining({
            ...
            allDay: true,
            calendarType: "commercial_alert_followup",
            sourceStage: "product_trial_alert_followup",
      ...
      expect(mockApiRequest).toHaveBeenLastCalledWith(
        ...
        expect.objectContaining({
          ...
          body: expect.objectContaining({
            ...
            allDay: true,
            calendarType: "personal_alert_followup",
            sourceStage: "lesson_alert_followup",
            linkedCourseId: "course-2",
      ...
      expect(mockApiRequest).toHaveBeenLastCalledWith(
        ...
        expect.objectContaining({
          ...
          body: expect.objectContaining({
            ...
            allDay: true,
            calendarType: "personal_alert_followup",
            sourceStage: "course_assignment_alert_followup",
            linkedCourseId: "course-3",
            linkedLessonId: "lesson-3",
      ...
      expect(mockApiRequest).toHaveBeenLastCalledWith(
        ...
        expect.objectContaining({
          ...
          body: expect.objectContaining({
            ...
            allDay: true,
            calendarType: "personal_alert_followup",
            sourceStage: "storefront_alert_followup",
