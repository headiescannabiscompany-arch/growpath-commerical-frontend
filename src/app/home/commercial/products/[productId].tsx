...
function DetailRow({ label, value }: { label: string; value?: unknown }) {
  const { palette } = useAppTheme();
  const styles = useMemo(() => createCommercialProductDetailStyles(palette), [palette]);
...
export function createCommercialProductDetailStyles(palette: ThemePalette) {
  return StyleSheet.create({
    ...
    detailValue: { color: palette.text, fontSize: 14, fontWeight: "800", marginTop: 4 },
    ...
    readyPill: { backgroundColor: palette.accentSoft, color: palette.success },
    focusBox: {
    ...
    focusValue: { color: palette.text, fontSize: 18, fontWeight: "900", marginTop: 4 },
    focusBody: { color: palette.textSoft, fontSize: 13, lineHeight: 19, marginTop: 6 },
    ...
    selectorButtonText: { color: palette.link, fontSize: 12, fontWeight: "900" },
    input: {
      backgroundColor: palette.surface,
      borderColor: palette.border,
      borderRadius: radius.card,
