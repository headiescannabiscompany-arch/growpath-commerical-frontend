...
export function createMixBuilderChooserStyles(palette: ThemePalette) {
  return StyleSheet.create({
    body: { backgroundColor: palette.page, padding: 16, gap: 12 },
    heading: { color: palette.text, fontSize: 20, fontWeight: "800" },
    intro: { color: palette.textMuted, lineHeight: 21, marginBottom: 4 },
    card: {
      borderWidth: 1,
    ...
    title: { color: palette.text, fontWeight: "800", marginBottom: 5 },
    ...
    supportHeading: { color: palette.text, fontSize: 15, fontWeight: "800" },
    supportText: { color: palette.textMuted, lineHeight: 19 },
    supportLink: {
    ...
    supportLinkText: { color: palette.link, fontWeight: "800" }
  });
}
