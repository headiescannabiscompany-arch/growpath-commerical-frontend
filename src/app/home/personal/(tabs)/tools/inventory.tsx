  ...
  return (
    <BackendCalculatorToolScreen
      ...
      fields={[
        ...
        { key: "quantity", label: "Quantity", defaultValue: "5", keyboardType: "numeric" },
        { key: "unit", label: "Unit", defaultValue: "lb" },
        { key: "reorderAt", label: "Reorder threshold", defaultValue: "2", keyboardType: "numeric" },
        { key: "cost", label: "Unit cost", defaultValue: "12", keyboardType: "numeric" },
        { key: "recipeUseRate", label: "Recipe use rate", defaultValue: "1", keyboardType: "numeric" }
      ]}
      buildPayload={(values, { growId }) => ({ growId, ...values })}
      buildMetrics={(outputs) => [
        { key: "name", label: "Item", value: outputs.name },
        { key: "quantity", label: "Quantity", value: `${outputs.quantity} ${outputs.unit || ""}` },
        { key: "availability", label: "Recipe batches", value: outputs.recipeAvailability },
