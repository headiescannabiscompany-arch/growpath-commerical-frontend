  ...
  return (
    <BackendCalculatorToolScreen
      ...
      fields={[
        ...
        { key: "flowerTime", label: "Flower time days", defaultValue: "63", keyboardType: "numeric" },
        { key: "stressNotes", label: "Stress notes, comma-separated", defaultValue: "", multiline: true },
        { key: "aromaFlavorNotes", label: "Aroma/flavor notes, comma-separated", defaultValue: "", multiline: true }
      ]}
      ...
      buildMetrics={(outputs) => [
        ...
        { key: "signals", label: "Keeper signals", value: outputs.keeperSignals?.length || 0 }
      ]}
