...
export default function HarvestReadinessToolRoute() {
  return (
    <BackendCalculatorToolScreen
      ...
      fields={[
        { key: "flowerDay", label: "Flower day", defaultValue: "56", keyboardType: "numeric" },
        { key: "breederFlowerTime", label: "Breeder flower time", defaultValue: "63", keyboardType: "numeric" },
        { key: "cloudyPercent", label: "Cloudy %", defaultValue: "65", keyboardType: "numeric" },
        { key: "amberPercent", label: "Amber %", defaultValue: "8", keyboardType: "numeric" },
        { key: "clearPercent", label: "Clear %", defaultValue: "10", keyboardType: "numeric" },
      ...
      defaultLogTitle={(outputs) => `Harvest readiness: ${outputs.readinessStatus || "check"}`}
      defaultTask={(outputs) => ({
        ...
        description: "Recheck trichomes, pistils, aroma, bud swell, and whole-plant maturity."
      })}
    />
  );
}
