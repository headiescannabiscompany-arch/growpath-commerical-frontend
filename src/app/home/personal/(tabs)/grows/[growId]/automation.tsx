...
export const createGrowAutomationStyles = (palette: ThemePalette) =>
  StyleSheet.create({
    container: { flex: 1, backgroundColor: palette.page },
    content: { padding: 20, paddingBottom: 32 },
    title: { fontSize: 24, fontWeight: "800", color: palette.text },
    subtitle: { marginTop: 6, color: palette.textMuted, lineHeight: 20 },
    ...
    description: { marginTop: 6, color: palette.textSoft, lineHeight: 19 },
    meta: { marginTop: 7, color: palette.textMuted, fontSize: 12, lineHeight: 17 },
    ...
    buttonText: { color: palette.link, fontWeight: "800" },
    primaryButtonText: { color: palette.accentText },
    dangerText: { color: palette.danger },
    status: { marginTop: 12, color: palette.success, fontWeight: "700" },
