...
const createStyles = (palette: ThemePalette) =>
  StyleSheet.create({
    ...
    h1: { color: palette.text, fontSize: 22, fontWeight: "800", marginBottom: 4 },
    ...
    cardTitle: { color: palette.text, fontSize: 16, fontWeight: "900", marginBottom: 8 },
    contextBanner: {
    ...
    contextTitle: { color: palette.link, fontWeight: "900" },
    form: { gap: 8 },
    ...
    rowTitle: { color: palette.text, fontSize: 16, fontWeight: "800", marginBottom: 4 },
