...
export default function FacilityComplianceAiDashboardRoute() {
  ...
  if (isLoading) return <View style={styles.container}><Text>Loading AI dashboard...</Text></View>;
  if (error) return <View style={styles.container}><Text>Failed to load AI dashboard.</Text></View>;

  return (
    <View style={styles.container}>
      <Text style={styles.h1}>Compliance AI Dashboard</Text>
      <Text style={styles.sub}>Live report-derived status for compliance operations.</Text>
