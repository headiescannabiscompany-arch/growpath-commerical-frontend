...
export const ROUTES = {
  ...
  COURSES: {
    ...
    UNPUBLISH: (id) => `${PREFIX}/courses/${id}/unpublish`,
    ARCHIVE: (id) => `${PREFIX}/courses/${id}/archive`,
  ...
  LIVES: {
    ...
    HOSTED_STATUS: `${PREFIX}/lives/hosted/status`,
    HOSTED_CHANNELS: `${PREFIX}/lives/hosted/channels`,
    HOSTED_CHANNEL: (channelId) => `${PREFIX}/lives/hosted/channels/${channelId}`,
    HOSTED_INPUT: (id) => `${PREFIX}/lives/${id}/hosted-input`,
    ROTATE_HOSTED_INPUT: (id) => `${PREFIX}/lives/${id}/hosted-input/rotate`,
    HOSTED_LIFECYCLE: (id) => `${PREFIX}/lives/${id}/hosted-status`,
    PLAYBACK: (id) => `${PREFIX}/lives/${id}/playback`,
