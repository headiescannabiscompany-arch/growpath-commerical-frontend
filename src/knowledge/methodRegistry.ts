...
export const methodRegistry: GrowPathMethod[] = [
  ...
  method(
    ...
    [
      ...
      "Allow a cannabis-enabled Personal account to run Harvest Readiness without creating a grow; bind standalone evidence and the receipt to that authenticated Personal workspace, keep canonicalGrowId null, and disable only grow-linked history, task, and batch actions.",
      ...
      "Never allow a Commercial or Facility Harvest analysis to run without an authorized shared grow merely because Personal standalone analysis is supported.",
