...
export const methodRegistry: GrowPathMethod[] = [
  ...
  method(
    ...
    [
      ...
      "Never accept a typed Product lifecycle status, publish an incomplete Product, change incomplete drafts during batch publication, or describe an external social composer as a completed post.",
