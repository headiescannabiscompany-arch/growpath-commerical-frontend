...
export const methodRegistry: GrowPathMethod[] = [
  ...
  method(
    ...
    [
      ...
      "Business Ask over an explicit subset of all seven B-03 record kinds plus independently selected read-only B-02 inventory, using a clearly labeled last-updated date range",
      ...
      "exact immutable B-03 revision citations and exact-identity, source-dated mutable B-02 item/lot citations with the lot bound to its parent item",
