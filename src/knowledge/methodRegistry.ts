...
export const methodRegistry: GrowPathMethod[] = [
  ...
  method(
    ...
    [
      ...
      "later user-authorized device coordinates synchronized into the existing linked private Field Study observation without creating a duplicate",
    ...
    [
      ...
      "Do not leave a later-authorized coordinate only on the ToolRun when a linked private observation already exists; synchronize it into that same observation as exact private data.",
