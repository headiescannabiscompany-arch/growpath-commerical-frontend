...
- `docs/engineering/CODEX_EXECUTION_GATES.md`: strict phased recovery + release gates.
...
See `CODEX_EXECUTION_GATES.md` for the deterministic phase-by-phase checklist.
