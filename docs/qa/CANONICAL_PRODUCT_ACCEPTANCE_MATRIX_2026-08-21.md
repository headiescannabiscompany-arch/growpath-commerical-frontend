...
| R-03 | Initial crawl, proof-based dead-code cleanup, and final full acceptance pass on new frozen SHAs                        | partial; automated, signed-in Personal and Facility-member slices passed; Facility repair live accepted; Personal task-link repair local; remaining roles, proven cleanup and final frozen-SHA pass open |
