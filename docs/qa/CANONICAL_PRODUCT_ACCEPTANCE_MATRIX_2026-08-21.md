...
| P-08 | Harvest Readiness works from ordinary phone media with sample ranges and reasons to harvest/wait                     | partial: max-80 frontend/backend live; 512 MiB client guard passed; 269.2 MB/270-second source retained 80 of 270 usable candidates across 40 timeline buckets; standalone reload and explicit cannabis/hemp context passed; free quote verified 80 unique/0 duplicates/7 signed batches/7 credits on frontend `4651b597` + backend `d9d5e68d`; paid operation, full-resolution role sufficiency, share and deletion/cleanup remain open |
