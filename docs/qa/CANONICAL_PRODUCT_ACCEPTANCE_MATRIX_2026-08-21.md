...
| R-05 | Owner-directed GrowPathAI-only hat designs/specifications/rights/BLVNK approval, machine files/sew-outs and non-sale trials complete | active after owner resumed on 2026-08-27; all 21 registered owner sources now have an explicit owner-approved disposition: twenty source-faithful conversions plus GP-24, which closes `FDGN4955.PNG` through the owner's explicit replacement with the established `NNNI1535.PNG` cream/forest GrowPathAI day-theme layout; GP-18 closes `CNKY2160.PNG`, GP-19 closes `GYSG2238.PNG`, GP-20 closes `GEOT0660.PNG`, GP-21 closes `PUMD5290.PNG`, GP-22 closes `MCXG5769.PNG`, and GP-23 closes `KVQV2209.PNG`, while GP-09 and GP-16 remain disclosed extra variants rather than additional source coverage. The product-detail sharing/image foundation was accepted on 2026-08-29: frontend `ff3855ec` supplies an uncropped contained image, full-image viewer, exact social targets and Copy Post; backend `3bf01061` supplies public exact-product OG/Twitter metadata and normalizes legacy first-party uploads through the API media host. Facebook's real composer initially fetched the exact Pale Sage hat image and title, but nine later owner-authorized posts lost or omitted their previews and were deleted. This cache-stability slice is reopened until deterministic versioned preview URLs, normal-browser exact-Product redirects, all-product live checks, and replacement-post persistence are accepted. Wholesale availability/cost, decorator-returned `DST` plus editable source, exact-blank sew-outs, remaining website presentation and trials remain open |
