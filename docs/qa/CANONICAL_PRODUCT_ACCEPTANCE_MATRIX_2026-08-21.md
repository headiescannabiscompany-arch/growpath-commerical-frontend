...
| R-05 | Owner-directed GrowPathAI-only hat designs/specifications/rights/BLVNK approval, machine files/sew-outs and non-sale trials complete | active after owner resumed on 2026-08-27; 20 of 21 registered owner sources have approved one-to-one conversions and one source direction remains open; GP-18 closes `CNKY2160.PNG`, GP-19 closes `GYSG2238.PNG`, GP-20 closes `GEOT0660.PNG`, GP-21 closes `PUMD5290.PNG`, GP-22 closes `MCXG5769.PNG`, and GP-23 closes `KVQV2209.PNG`, while GP-09 and GP-16 remain disclosed extra variants rather than additional source coverage; wholesale availability/cost, decorator-returned `DST` plus editable source, exact-blank sew-outs, remaining owner approval, website presentation and trials remain open |
