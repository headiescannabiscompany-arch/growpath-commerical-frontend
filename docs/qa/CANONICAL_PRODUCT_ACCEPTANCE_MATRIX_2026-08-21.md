...
| P-08 | Harvest Readiness works from ordinary phone media with sample ranges and reasons to harvest/wait                     | **live accepted:** one owner-authorized Facility Deep Review selected and analyzed 80/80 stills in seven signed batches for the quoted seven credits; the truthful result reported insufficient resolved evidence rather than invented percentages, exact zooms and an eight-zoom sanitized owner-private Feed draft restored, standalone save returned 201, and the exact Facility Saved Run restored without rerun or another charge. PRs `#827`-`#829` are merged/live and exact evidence is frozen in the P-08 completion record. The owner retained private media/result/draft; optional permanent deletion, publication and Facebook sharing are later owner actions, not open implementation. Final-candidate regression only. |
...
| S-08 | Discover provides useful storefront/course/video/forum/live/Nature previews, filters, links and empty states       | live hat-catalog slice accepted on 2026-08-29: the public Discover API returned 24 published Products plus two explicitly public trials, and the live Discover Product rail rendered exact saved hat images and Product destinations; populated video plus Nature/Feed/store/course/live empty-state composition was already accepted; remaining populated-family regression stays open |
...
| R-03 | Initial crawl, proof-based dead-code cleanup, and final full acceptance pass on new frozen SHAs                        | core release gate accepted and reconciled through frontend `63a0bd2a` plus backend `ff1e8b6`: the retained cross-workspace/public/Admin crawl and cleanup PR `#835` remain authoritative for unaffected routes; the post-cleanup catalog/share changes passed complete frontend CI `33269478735`, production preflight `33269478722`, the 324-frontend-route/225-backend-route surface audit, release/corruption/export/workflow guards, canonical live-URL checks and the affected production catalog/share acceptance recorded under R-05. Named physical/provider/role-transition gates remain external rather than reopening accepted routes |
| R-04 | Independent reviewer suggestions are isolated, itemized and deliberately accepted/rejected                             | blocked on the separate reviewer identity: the owner-approved bounded invitation was sent from GrowPathAI Support on 2026-08-27, but a 2026-08-29 production Admin search returned no account for `roberto.tomas.cuentas@gmail.com`. Account creation/verification, any limited test-workspace access, returned findings, explicit dispositions, preview evidence and production approval remain open; owner/Admin credentials must not be substituted                                                                                                      |
| R-05 | Owner-directed GrowPathAI-only hat designs/specifications/rights/BLVNK approval, machine files/sew-outs and non-sale trials complete | active after owner resumed on 2026-08-27; all 21 registered owner sources now have an explicit owner-approved disposition: twenty source-faithful conversions plus GP-24, which closes `FDGN4955.PNG` through the owner's explicit replacement with the established `NNNI1535.PNG` cream/forest GrowPathAI day-theme layout; GP-18 closes `CNKY2160.PNG`, GP-19 closes `GYSG2238.PNG`, GP-20 closes `GEOT0660.PNG`, GP-21 closes `PUMD5290.PNG`, GP-22 closes `MCXG5769.PNG`, and GP-23 closes `KVQV2209.PNG`, while GP-09 and GP-16 remain disclosed extra variants rather than additional source coverage. The product-detail sharing/image foundation is live accepted: frontend behavior began at `dcee1fd3` and its final typed release is `63a0bd2a`; backend `ff1e8b6` emits state-versioned preview identities, exact canonical Product metadata and normal-browser redirects. Production acceptance on 2026-08-29 covered 24/24 crawler previews, 24/24 preview images, 24/24 normal-browser redirects and 24/24 exact Product pages; Discover returned 24 Products plus two separate trials and visibly rendered the saved hat images. The nine owner-authorized broken Facebook posts were deleted, then Midnight Stealth, Night Current, Signal Classic, Volt Path, Glacier Contrast, Royal Current, Sage/Olive Circuit Contrast, Day Path and Orange Tonal Circuit were recreated one at a time; every composer and resulting profile post was verified to retain its exact titled hat image. Do not rebuild this accepted preview/share slice. Wholesale availability/cost, decorator-returned `DST` plus editable source, exact-blank sew-outs, remaining website presentation and trials remain open |
...
5. Implement and accept every remaining in-scope functional gap. A started item may remain
   ...
   an unfinished implementation is never silently abandoned or treated as complete. P-08 is
   closed and must not be rebuilt without a reproduced regression.
