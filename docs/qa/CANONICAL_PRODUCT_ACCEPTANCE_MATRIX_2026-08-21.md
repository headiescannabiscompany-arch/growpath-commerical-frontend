...
| R-05 | Owner-directed GrowPathAI-only hat designs/specifications/rights/BLVNK approval, machine files/sew-outs and non-sale trials complete | active after owner resumed on 2026-08-27; sixteen real-BLVNK-mapped concepts and digitizer handoff retained, with 15 individual concept images owner-approved and GP-16 remaining; wholesale availability/cost, decorator-returned `DST` plus editable source, exact-blank sew-outs, remaining owner approval, website presentation and trials remain open |
