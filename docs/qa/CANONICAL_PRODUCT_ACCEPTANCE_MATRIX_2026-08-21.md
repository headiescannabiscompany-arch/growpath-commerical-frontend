...
| P-08 | Harvest Readiness works from ordinary phone media with sample ranges and reasons to harvest/wait                     | partial: max-80 frontend/backend live; 512 MiB client guard passed; 269.2 MB/270-second private source retained 80 of 270 usable candidates across 40 timeline buckets; exact standalone source/frame set restored after clean production reload on frontend `4a308435`; visual review, quote/paid operation, share and deletion/cleanup acceptance remain open |
