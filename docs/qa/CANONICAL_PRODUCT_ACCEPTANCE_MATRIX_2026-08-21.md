...
| P-08 | Harvest Readiness works from ordinary phone media with sample ranges and reasons to harvest/wait                     | max-80 frontend/backend live; Facility lineage repaired; production proved truthful no-credit extractor failure for a 1.61 GB source above the 512 MiB protected-extraction ceiling; client pre-upload size guard plus bounded-video/reload/share/delete exact-SHA live acceptance open |
