...
| ID   | User story                                                                                                             | Status                                                                                                                                                                                                                                                                           |
| ---- | ---------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| N-01 | Globe supports zoom/cluster/list/search/filter plus photo/date/description cards and an honest zero-pin state          | bounded visibility regression reproduced: all four Maydale cards load but their shared cluster begins off-screen; current candidate auto-fits privacy-safe results and adds an explicit return-to-results control, with local focused tests passing and production deploy/visual acceptance open                                                  |
