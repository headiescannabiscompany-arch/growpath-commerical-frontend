...
| ID   | User story                                                                                                             | Status                                                                                                                                                                                                                                                                           |
| ---- | ---------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| N-01 | Globe supports zoom/cluster/list/search/filter plus photo/date/description cards and an honest zero-pin state          | focus/return control is live at `0f1f0964`, but production visual/click checks proved the WebGL cluster circle still absent; follow-up candidate adds a visible keyboard-operable coordinate-group marker while retaining clustering, with local and production selection acceptance open                                                          |
