...
| ------------------------------------------------------------------------------------------ | ------------- | -------------: | -------------------------------------------------------------------------------------------------------------------------------- |
| `tmp/frontend-run-comparison` / `codex/run-comparison-evidence`                            | P07           |              3 | Run-comparison workspace, backend history calculations, method registry, validators, and tests.                                  |
| `frontend-trichome-coverage-policy` / `codex/trichome-coverage-policy`                     | P08–P09       |              3 | Harvest/trichome evidence-coverage policy and app-readable registry updates.                                                     |
