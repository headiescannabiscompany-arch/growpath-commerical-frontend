...
- [ ] Production IPM acceptance still requires fresh photo upload/photo-prefill billing, failed-provider refund proof, and independent pest/pathogen accuracy review using owner-approved sources.
