...
- [~] Verify Storefront, Feed/Campaigns, Forum/Q&A, Lives, Orders, Analytics, Product Lines, Batches/Lots, Trials, and Inventory navigation names and hierarchy are clear and not duplicative.
  ...
  - 2026-07-24 Commercial production navigation and record-linking polish is live through frontend merge `1b998f992dbe0f6c17ef3b4f09db71842b26cbcb`: compact navigation retains every omitted workspace under More; Inventory Support creation is a named action; Product Trial, Product Batch, and Inventory Support creation prefer readable owner-scoped record choices; and compact campaign rails no longer overlap or intercept form controls. The signed-in production pass created no records. Intentional create/edit/reload coverage, real public-user handoffs, responsive visual QA, screenshot/video capture, and independent acceptance remain open; see `docs/qa/COMMERCIAL_PRODUCTION_WORKFLOW_NAVIGATION_EVIDENCE_2026-07-24.md`.
