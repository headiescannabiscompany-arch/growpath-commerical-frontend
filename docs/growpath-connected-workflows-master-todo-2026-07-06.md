...
- Personal, Commercial, and Facility tab layouts now hide non-tab routes with Expo Router `href: null` instead of invisible tab buttons. The implementation shipped in frontend merge `02edbdab697c5f578837eca92561bfe34b49ccd3`; source-contract and rendered 375/390px tests verify exactly six visible labels per workspace. Exact-SHA production checks confirmed six labeled tabs on Personal and Facility without blank slots. Current Commercial role-loaded and narrow-width Browser acceptance remains open.
